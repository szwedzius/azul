...
public class FactoriesCenter {
    ...
    private FactoriesCenter(){
        ...
        whiteNumber.setFont(new Font("Georgia", Font.PLAIN, 35));
        whiteNumber.setForeground(new Color(236,239,244));
        blackNumber.setForeground(new Color(236,239,244));
        blueNumber.setForeground(new Color(236,239,244));
        yellowNumber.setForeground(new Color(236,239,244));
        redNumber.setForeground(new Color(236,239,244));
        blackNumber.setFont(new Font("Georgia", Font.PLAIN, 35));
        blueNumber.setFont(new Font("Georgia", Font.PLAIN, 35));
        redNumber.setFont(new Font("Georgia", Font.PLAIN, 35));
        yellowNumber.setFont(new Font("Georgia", Font.PLAIN, 35));
